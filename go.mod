module github.com/kelseyhightower/monolith

require (
	cloud.google.com/go v0.33.1
	contrib.go.opencensus.io/exporter/stackdriver v0.8.0
	git.apache.org/thrift.git v0.0.0-20181116205017-0882354f28a2 // indirect
	...
	github.com/kelseyhightower/monolith/bar v0.0.0-20181119014621-028cdb21d5b9
	github.com/kelseyhightower/monolith/foo v0.0.0-20181119014621-028cdb21d5b9
